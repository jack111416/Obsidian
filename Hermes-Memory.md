...
User prefers visual knowledge bases combining screenshots + transcripts. Expects B站视频提取工作流: metadata → audio download → ASR → markdown chunks → summary → visual elements.
